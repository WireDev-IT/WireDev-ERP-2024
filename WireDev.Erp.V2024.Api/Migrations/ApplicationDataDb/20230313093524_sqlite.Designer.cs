...
namespace WireDev.Erp.V1.Api.Migrations.ApplicationDataDb
{
    ...
    [Migration("20230313093524_sqlite")]
            ...
            modelBuilder.Entity("WireDev.Erp.V1.Models.Settings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Uuid = new Guid("47a542b6-4856-4e44-9bc4-15bd7d896eed"),
                            NextGroupNumber = 100,
            ...
            modelBuilder.Entity("WireDev.Erp.V1.Models.Storage.Price", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Uuid = new Guid("bdd9faca-f05f-4658-a1a7-61c978078a13"),
                            Archived = false,
            ...
            modelBuilder.Entity("WireDev.Erp.V1.Models.Storage.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Prices = "[\"bdd9faca-f05f-4658-a1a7-61c978078a13\"]",
                            Properties = "{}",
                            Used = false
                        });
                });
            ...
            modelBuilder.Entity("WireDev.Erp.V1.Models.Storage.Purchase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Uuid = new Guid("0265d7dc-da76-41d1-8c75-43dfb919ae64"),
                            DatePosted = new DateTime(2023, 3, 13, 9, 35, 24, 362, DateTimeKind.Utc).AddTicks(630),
                            Items = "[]",
                            Posted = true,
                            TotalPrice = 0m,
                            Type = 0
