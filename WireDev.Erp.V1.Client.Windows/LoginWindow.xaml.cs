...
"M 177.5,402.5 C 144.663,402.063 112.329,402.063 80.5,402.5C 112.465,370.035 144.632,337.701 177,305.5C 177.5,337.832 177.667,370.165 177.5,402.5 Z"),
        ...
        private Task SetServerStatus(bool status)
        {
            ...
            {
                case true:
                    ServerShield.Status = "Online";
                    ServerShield.Color = (Brush?)new BrushConverter().ConvertFrom("Green");
                    break;
                case false:
                    ServerShield.Status = "Offline";
                    ServerShield.Color = (Brush?)new BrushConverter().ConvertFrom("Red");
                    break;
            }
            return Task.CompletedTask;
        }
